...
public class DangNhap extends JFrame {
	...
	protected void classification(String type) {
		switch (type) {
		case "DoiTac": {
			dt = new DoiTac(userName.getText(),String.valueOf(password.getPassword()));
			dt.setVisible(true);
			this.dispose();
		...
		case "KhachHang": {
			kh = new KhachHang(userName.getText(),String.valueOf(password.getPassword()));
			kh.setVisible(true);
			this.dispose();
		...
		case "NhanVien": {
			nv = new NhanVien(userName.getText(),String.valueOf(password.getPassword()));
			nv.setVisible(true);
			this.dispose();
		...
		case "TaiXe": {
			tx = new TaiXe(userName.getText(),String.valueOf(password.getPassword()));
			tx.setVisible(true);
			this.dispose();
		...
		case "QuanTri": {
			qt = new QuanTri(userName.getText(),String.valueOf(password.getPassword()));
			qt.setVisible(true);
			this.dispose();
