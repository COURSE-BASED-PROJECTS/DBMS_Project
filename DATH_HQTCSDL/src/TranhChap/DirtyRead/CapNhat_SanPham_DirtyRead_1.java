...
public class CapNhat_SanPham_DirtyRead_1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CapNhat_SanPham_DirtyRead_1 frame = new CapNhat_SanPham_DirtyRead_1();
	 ...
	 * Create the frame.
	 */
	public CapNhat_SanPham_DirtyRead_1() {
		...
		lblSTin.setHorizontalAlignment(SwingConstants.LEFT);
		lblSTin.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lblSTin.setBounds(210, 114, 71, 34);
		panel.add(lblSTin);
		...
		priceText.setBounds(252, 114, 92, 34);
		panel.add(priceText);
	...
	protected void do_btnNewButton_actionPerformed(ActionEvent e) {
		...
		cc.setGiasp(priceText.getText());
		
		if(DirtyRead_1.capnhat_cungcap(cc))
