...
public class CapNhat_DiaChi_DirtyRead_3 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CapNhat_DiaChi_DirtyRead_3 frame = new CapNhat_DiaChi_DirtyRead_3();
	 ...
	 * Create the frame.
	 */
	public CapNhat_DiaChi_DirtyRead_3() {
		...
		diachiText.setBounds(223, 25, 158, 34);
	...
	protected void do_btnNewButton_actionPerformed(ActionEvent e) {
		if(DirtyRead_3.capnhat_diachi(maddhText.getText(),diachiText.getText()))
