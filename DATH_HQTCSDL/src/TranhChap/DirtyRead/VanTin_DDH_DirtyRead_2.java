...
public class VanTin_DDH_DirtyRead_2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VanTin_DDH_DirtyRead_2 frame = new VanTin_DDH_DirtyRead_2();
	...
	protected void do_btnNewButton_actionPerformed(ActionEvent e) {
		DefaultTableModel defaultTableModel = new DefaultTableModel();
		initialRow(defaultTableModel, nameColumn_DonDH);
		table.setModel(DirtyRead_2.vantin_tinhtrang(defaultTableModel, maddhText.getText(), false));
	}
	protected void do_btnNewButton_1_actionPerformed(ActionEvent e) {
		DefaultTableModel defaultTableModel = new DefaultTableModel();
		initialRow(defaultTableModel, nameColumn_DonDH);
		table.setModel(DirtyRead_2.vantin_tinhtrang(defaultTableModel, maddhText.getText(), true));
	}
}
