...
public class CapNhat_KhuyenMai_LostUpdate_2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CapNhat_KhuyenMai_LostUpdate_2 frame = new CapNhat_KhuyenMai_LostUpdate_2();
	 ...
	 * Create the frame.
	 */
	public CapNhat_KhuyenMai_LostUpdate_2() {
		setTitle("Cập nhật khuyến mãi");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 1146, 391);
		...
		JLabel lblMsp = new JLabel("Chiết khấu");
		...
		panel_2.setBounds(411, 10, 711, 344);
		contentPane.add(panel_2);
		panel_2.setLayout(null);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(10, 20, 691, 319);
		...
		panel_1.setBounds(10, 211, 391, 141);
		contentPane.add(panel_1);
		
		JButton btnCpNhtKhuyn = new JButton("Cập nhật khuyến mãi");
		btnCpNhtKhuyn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				do_btnCpNhtKhuyn_actionPerformed(e);
			}
		});
		btnCpNhtKhuyn.setFont(new Font("Tahoma", Font.PLAIN, 12));
		btnCpNhtKhuyn.setBounds(10, 27, 169, 47);
		panel_1.add(btnCpNhtKhuyn);
		
		JButton btnNewButton_1 = new JButton("Cập nhật khuyến mãi (fix)");
		...
		btnNewButton_2.setBounds(146, 94, 93, 34);
	...
	protected void do_btnCpNhtKhuyn_actionPerformed(ActionEvent e) {
		...
		if(LostUpdate_3.capnhat_gia(cc,giaText.getText(),false,true)) {
	...
	protected void do_btnNewButton_1_actionPerformed(ActionEvent e) {
		...
		if(LostUpdate_3.capnhat_gia(cc,giaText.getText(),true,true)) {
			JOptionPane.showConfirmDialog(contentPane, "Cập nhật thành công", "Cập nhật", JOptionPane.CLOSED_OPTION, 0);
			loadData("CUNGCAP", nameColumn_CungCap, table);
		}
		else {
