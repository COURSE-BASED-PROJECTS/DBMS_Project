...
public class VanTin_SanPham_PhantomRead_1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VanTin_SanPham_PhantomRead_1 frame = new VanTin_SanPham_PhantomRead_1();
	 ...
	 * Create the frame.
	 */
	public VanTin_SanPham_PhantomRead_1() {
		...
		JLabel lblMaDdh = new JLabel("Số lượng sản phẩm");
	...
	protected void do_btnNewButton_actionPerformed(ActionEvent e) {
		DefaultTableModel defaultTableModel = new DefaultTableModel();
		initialRow(defaultTableModel, nameColumn_SanPham);
		soluongText.setText(PhantomRead_1.soluong_sp());
		table.setModel(PhantomRead_1.vantin_sanpham(defaultTableModel, false));
	}
	protected void do_btnNewButton_1_actionPerformed(ActionEvent e) {
		DefaultTableModel defaultTableModel = new DefaultTableModel();
		initialRow(defaultTableModel, nameColumn_SanPham);
		soluongText.setText(PhantomRead_1.soluong_sp());
		table.setModel(PhantomRead_1.vantin_sanpham(defaultTableModel, true));
	}
}
