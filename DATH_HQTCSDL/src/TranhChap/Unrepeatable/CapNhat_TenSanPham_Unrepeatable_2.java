...
public class CapNhat_TenSanPham_Unrepeatable_2 extends JFrame {

	private JPanel contentPane;
	private JTable table;
	private JTextPane tenmoiText;
	private JTextPane mspText;
	private JTextPane tencuText;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CapNhat_TenSanPham_Unrepeatable_2 frame = new CapNhat_TenSanPham_Unrepeatable_2();
	 ...
	 * Create the frame.
	 */
	public CapNhat_TenSanPham_Unrepeatable_2() {
		...
		JLabel lblMsp = new JLabel("Tên SP mới");
		...
		JLabel lblMcn = new JLabel("Tên SP cũ");
		...
		mspText.setBounds(73, 25, 92, 34);
		panel.add(mspText);
		
		tenmoiText = new JTextPane();
		tenmoiText.setFont(new Font("Tahoma", Font.PLAIN, 13));
		tenmoiText.setBounds(73, 114, 92, 34);
		panel.add(tenmoiText);
		
		tencuText = new JTextPane();
		tencuText.setFont(new Font("Tahoma", Font.PLAIN, 13));
		tencuText.setBounds(252, 25, 92, 34);
		panel.add(tencuText);
	...
	protected void do_btnNewButton_actionPerformed(ActionEvent e) {
		if(Unrepeatable_2.capnhat_tensanpham(mspText.getText(),tencuText.getText(),tenmoiText.getText(),false)) {
	...
	protected void do_btnNewButton_1_actionPerformed(ActionEvent e) {
		if(Unrepeatable_2.capnhat_tensanpham(mspText.getText(),tencuText.getText(),tenmoiText.getText(),true)) {
			JOptionPane.showConfirmDialog(contentPane, "Cập nhật thành công", "Cập nhật", JOptionPane.CLOSED_OPTION, 0);
			loadData("SANPHAM", nameColumn_SanPham, table);
		}
		else {
