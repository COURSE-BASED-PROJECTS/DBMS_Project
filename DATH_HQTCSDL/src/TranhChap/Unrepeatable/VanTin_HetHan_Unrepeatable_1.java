...
public class VanTin_HetHan_Unrepeatable_1 extends JFrame {
	...
	private JTextPane ngayhethanText;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VanTin_HetHan_Unrepeatable_1 frame = new VanTin_HetHan_Unrepeatable_1();
	 ...
	 * Create the frame.
	 */
	public VanTin_HetHan_Unrepeatable_1() {
		...
		mstText.setBounds(84, 30, 92, 34);
		panel_1.add(mstText);
		
		JLabel lblTg = new JLabel("TGHL");
		lblTg.setHorizontalAlignment(SwingConstants.CENTER);
		lblTg.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lblTg.setBounds(186, 30, 71, 34);
		panel_1.add(lblTg);
		
		ngayhethanText = new JTextPane();
		ngayhethanText.setFont(new Font("Tahoma", Font.PLAIN, 13));
		ngayhethanText.setBounds(254, 30, 94, 34);
		panel_1.add(ngayhethanText);
...
//		loadData("CUNGCAP", nameColumn_CungCap, table);
		...
		initialRow(defaultTableModel,nameColumn_HOPDONG);
	...
	protected void do_btnNewButton_actionPerformed(ActionEvent e) {
		DefaultTableModel defaultTableModel = new DefaultTableModel();
		initialRow(defaultTableModel, nameColumn_HOPDONG);
		table.setModel(Unrepeatable_1.vantin_hopdong(defaultTableModel,mstText.getText(),ngayhethanText.getText(), false));
	}
	protected void do_btnNewButton_1_actionPerformed(ActionEvent e) {
		DefaultTableModel defaultTableModel = new DefaultTableModel();
		initialRow(defaultTableModel, nameColumn_HOPDONG);
		table.setModel(Unrepeatable_1.vantin_hopdong(defaultTableModel, mstText.getText(),ngayhethanText.getText(), true));
	}
}
