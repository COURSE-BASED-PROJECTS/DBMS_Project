...
public class VanTin_SanPham_Unrepeatable_2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VanTin_SanPham_Unrepeatable_2 frame = new VanTin_SanPham_Unrepeatable_2();
	 ...
	 * Create the frame.
	 */
	public VanTin_SanPham_Unrepeatable_2() {
		...
		tenspText.setBounds(84, 30, 92, 34);
		panel_1.add(tenspText);
...
//		loadData("CUNGCAP", nameColumn_CungCap, table);
		...
		initialRow(defaultTableModel,nameColumn_SanPham);
	...
	protected void do_btnNewButton_actionPerformed(ActionEvent e) {
		DefaultTableModel defaultTableModel = new DefaultTableModel();
		initialRow(defaultTableModel, nameColumn_SanPham);
		table.setModel(Unrepeatable_2.vantin_tensanpham(defaultTableModel,tenspText.getText(), false));
	}
	protected void do_btnNewButton_1_actionPerformed(ActionEvent e) {
		DefaultTableModel defaultTableModel = new DefaultTableModel();
		initialRow(defaultTableModel, nameColumn_SanPham);
		table.setModel(Unrepeatable_2.vantin_tensanpham(defaultTableModel,tenspText.getText(), true));
	}
}
