...
--	VALUES	('A12', 'ntvinh', 'TaiXe', 1),
--			('B14', 'lhai', 'TaiXe', 1),

--			--Tài khoản của KHÁCH HÀNG
--			('201A','tmanh','KhachHang', 1),
--			('102B','vkmy','KhachHang', 1),

--			--Tài khoản của ĐỐI TÁC
--			('0312614186', 'nvan', 'DoiTac', 1),
--			('0191818716', 'ndquan', 'DoiTac', 1)